alter table public.companies
  add column if not exists auto_clock_out_time text not null default '12:00',
...
comment on column public.companies.auto_clock_out_time is
  'Company local wall-clock time in HH:MM for automatic clock-out. Default is 12:00.';
